...
class Game
  ...
  def next_step(bukva)
    ...
    # Проверяем содержится ли введенная буква в загаданном слове
    # А также дополнительно проверяем:
    # если ползователь ввёл букву "е" - есть ли в слове буква "ё"
    # если ползователь ввёл букву "ё" - есть ли в слове буква "е"
    ...
    if @letters.include?(bukva) ||
     ...
     (bukva == "й" && letters.include?("и"))
      ...
      # Если полученный массив пуст, значит мы угадали все слово
